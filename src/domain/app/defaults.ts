...
export function createStarterCategories(workspaceId: string): Category[] {
  const groups = [
    ...
    { name: "데이트/여행", fixedOrVariable: "variable", necessity: "discretionary" },
    { name: "개인", fixedOrVariable: "variable", necessity: "discretionary" },
  ...
  const items = [
    ...
    { name: "연회비", parentName: "주거/고정비", fixedOrVariable: "fixed", necessity: "discretionary" },
    ...
    { name: "카페", parentName: "생활비", fixedOrVariable: "variable", necessity: "discretionary" },
    ...
    { name: "회사 식대", parentName: "생활비", fixedOrVariable: "variable", necessity: "essential" },
    { name: "식비", parentName: "생활비", fixedOrVariable: "variable", necessity: "essential" },
    ...
    { name: "약국", parentName: "의료/건강", fixedOrVariable: "variable", necessity: "essential" },
    ...
    { name: "데이트", parentName: "데이트/여행", fixedOrVariable: "variable", necessity: "discretionary" },
    { name: "여행", parentName: "데이트/여행", fixedOrVariable: "variable", necessity: "discretionary" },
    { name: "식비", parentName: "데이트/여행", fixedOrVariable: "variable", necessity: "discretionary" },
    { name: "카페", parentName: "데이트/여행", fixedOrVariable: "variable", necessity: "discretionary" },
    { name: "개인지출", parentName: "개인", fixedOrVariable: "variable", necessity: "discretionary" },
