  ...
  const steps: GuideStep[] = [
    {
      ...
      tips: [
        ...
        "소개가 끝나면 카드내역 화면에서 샘플 업로드와 검토 정리까지 바로 이어집니다.",
      ],
      completed: false,
    ...
    },
    {
      ...
      fallbackSelector: '[data-guide-target="nav-people"]',
      ctaLabel: "자산 설정 보기",
      activeLabel: "확인했습니다",
      tips: [
    ...
    },
    {
      ...
      tips: [
        ...
        "실습 단계에서는 여기서 만든 구조가 카드내역 분류에 그대로 연결됩니다.",
      ],
      completed: false,
      requiresTargetVisit: true,
      blocking: true,
    ...
    },
    {
      ...
      targetPath: "/account-transfers",
      targetSelector: '[data-guide-target="account-transfers-entry"]',
      fallbackSelector: '[data-guide-target="nav-account-transfers"]',
      ctaLabel: "이체내역 보기",
      activeLabel: "확인했습니다",
      tips: [
        "지금 버전에서는 소개 중심으로만 보고, 실제 실습은 카드내역 화면에서 진행합니다.",
    ...
    },
    {
      ...
      fallbackSelector: '[data-guide-target="nav-transactions"]',
      ctaLabel: "카드내역 보기",
      activeLabel: "확인했습니다",
      tips: [
    ...
    },
    {
      ...
      title: "샘플 업로드 따라하기",
      description: "이제 직접 해봅니다. 샘플 카드내역을 불러오면 검토와 미분류 정리가 같은 흐름으로 이어집니다.",
      targetPath: "/transactions",
