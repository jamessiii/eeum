...
export function getWorkspaceGuide(state: AppState, workspaceId: string): WorkspaceGuide {
  ...
  const steps: GuideStep[] = [
    ...
    },
    {
      ...
      tips: ["가계부 v2 엑셀을 올리거나 수동 거래를 추가해보세요.", "거래가 쌓이면 분류와 통계가 바로 시작됩니다."],
      completed: hasTransactions,
    },
    {
      id: "recurring",
      title: "반복 지출 카테고리 지정",
      description: "반복적으로 등장하는 가맹점은 먼저 카테고리를 묶어두면 이후 분류가 훨씬 빨라집니다.",
      targetPath: "/categories",
      ctaLabel: "반복 지출 분류하기",
      tips: ["구독, 보험, 통신비처럼 반복되는 거래부터 분류해보세요.", "한 번 지정하면 같은 가맹점 거래 여러 건에 함께 반영됩니다."],
    ...
    },
    {
      ...
      targetPath: "/reviews",
      ctaLabel: "검토함 열기",
      tips: ["중복 후보는 바로 제외하지 말고 먼저 내용을 확인하세요.", "내부이체와 환불 후보를 정리하면 지출 수치가 더 깔끔해집니다."],
