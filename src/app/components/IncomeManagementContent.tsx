...
import { EmptyStateCallout } from "./EmptyStateCallout";
...
export function IncomeManagementContent() {
  ...
  useEffect(() => {
    ...
    if (!matchedSuggestion || isAmountDirty) return;
        ...
        <section className="card shadow-sm income-entry-card-shell" style={getMotionStyle(0)}>
          <div className="section-head income-entry-section-head">
            <div>
              ...
              <p className="transaction-grid-meta">{selectedHistoryYear}년 수입을 행 단위로 입력할 수 있습니다.</p>
            </div>
          </div>
              ...
              <label>
                ...
                <div className="income-source-field" ref={sourceFieldRef}>
                  <input
                    ...
                    onKeyDown={(event) => {
                      if (event.key === "Escape") setIsSourceSuggestionOpen(false);
                    }}
                        ...
                        <div className="d-flex justify-content-between align-items-start gap-3">
                          <div className="review-card-main">
                            <span className="review-type">
                              {entry.ownerPersonId ? peopleMap.get(entry.ownerPersonId) ?? "사용자" : "사용자 없음"}
                            </span>
