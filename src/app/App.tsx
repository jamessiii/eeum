...
import { createBackupContent, summarizeBackupPayload } from "../domain/app/backup";
...
import { useDotoriAutoSync } from "./useDotoriAutoSync";
...
function AppFrame() {
  ...
  useDotoriAutoSync({
    ...
    importState,
    isReady,
    localBackupCommitId: localBackupSummary.backupCommitId ?? null,
    localBackupContent,
